...
enum AutoAbility {
    ...
    DarkDraw = "darkDraw",
    DarkElementStarter = "darkElementStarter",
    ...
    EXPUp = "expUp",
    EarthDraw = "earthDraw",
    EarthElementStarter = "earthElementStarter",
    ...
    FireDraw = "fireDraw",
    FireElementStarter = "fireElementStarter",
    GilUp = "gilUp",
    ...
    LightDraw = "lightDraw",
    LightElementStarter = "lightElementStarter",
    ...
    PrismaticElementGenerator = "prismaticElementGenerator",
    ...
    WaterDraw = "waterDraw",
    WaterElementStarter = "waterElementStarter",
    WindDraw = "windDraw",
    WindElementStarter = "windElementStarter",
}
